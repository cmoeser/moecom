...
var GlobalNavigation = (function () {
    function GlobalNavigation($, Utils) {
        ...
        var activateMobileTransitions = function activateMobileTransitions(delay) {
            if (!$globalHeader.hasClass(dynamicClasses.mobileTransitionsActive)) {
        ...
        var deactivateMobileTransitions = function deactivateMobileTransitions() {
        ...
        var setMobileNavHeightToWindowHeight = function setMobileNavHeightToWindowHeight() {
            $subNavs.css('max-height', $window.height());
        };

        var resetMobileNavHeight = function resetMobileNavHeight() {
            $subNavs.removeAttr('style');
        };

        var allowActiveSubNavScroll = function allowActiveSubNavScroll($subNav) {
            $subNav.removeAttr('style');
        };

        var enableScrollBounceFix = function enableScrollBounceFix() {
        ...
        this.openMobileMenu = function () {
            if (!$mainNavSection.hasClass(dynamicClasses.displayBlock)) {
                // displayBlock check to make sure menu is fully closed
        ...
        this.closeMobileMenu = function () {
            ...
            window.setTimeout(function () {
                var $activeSubNav = $('.' + dynamicClasses.subNavActive);
        ...
        this.bindMobileMenuListeners = function () {
            ...
            $closeSubNav.on('click', function () {
                var $currentNavItem = $(this).parents('.' + selectors.navItem);
        ...
        this.bindAccessibilityListeners = function () {
            ...
            if (!webkitOverflowScrollingSupport) {
                // causes menu to immediately close in iOS, disabling this accessibility tab through helper
